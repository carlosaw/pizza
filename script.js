...
pizzaJson.map((item, index)=>{
    ...
    pizzaItem.querySelector('a').addEventListener('click', (e)=>{//Evento de clique na tag 'a'
        ...
        c('.pizzaInfo h1').innerHTML = pizzaJson[key].name;//Pega os dados da pizza para o modal
